    ...
    <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-semibold tracking-tight text-[#1c3053] mb-6"
        >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-gray-500 font-light max-w-2xl mx-auto mb-12"
        >
          Premium properties, transparent service, and a modern approach to
          renting in the UK.
        </motion.p>
        ...
        <motion.form
          ...
          className="max-w-3xl mx-auto flex flex-col md:flex-row gap-4 bg-white p-4 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-gray-100"
        >
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-14 pr-4 py-4 rounded-2xl bg-transparent text-gray-900 placeholder:text-gray-400 focus:outline-none text-lg"
            />
          </div>

          <button
            type="submit"
            className="bg-[#1c3053] text-white px-8 py-4 rounded-2xl font-medium text-lg hover:bg-[#ae884e] transition-all shadow-md"
          >
            Search Properties
          </button>
        </motion.form>
  ...
  const benefits = [
    {
      ...
      desc: "Carefully selected homes from trusted landlords ensuring high standards.",
    },
    {
      num: "02",
      title: "Easy Viewings",
      desc: "Book property viewings online at a time that perfectly suits your schedule.",
    },
    {
      num: "03",
      title: "Dedicated Agents",
      desc: "Speak directly with a property professional personally assigned to your home.",
    },
    {
      num: "04",
      title: "A Better Experience",
      desc: "A simple, modern and highly transparent way to find your next rental.",
    },
  ];
  ...
  const steps = [
    {
      ...
      desc: "Search our portfolio of available premium rental properties.",
    },
    {
      icon: Calendar,
      title: "Book A Viewing",
      desc: "Choose your preferred date and time online instantly.",
    },
    {
      icon: Home,
      title: "Move In",
      desc: "Our team guides you seamlessly through the entire process.",
    },
  ];
    ...
    <section className="py-24 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl text-gray-600 font-light leading-relaxed mb-10">
          OneKey Estate Agency combines cutting-edge modern technology with
          dedicated personal service. We believe finding your next home should
          be transparent, straightforward, and entirely stress-free.
        </p>
