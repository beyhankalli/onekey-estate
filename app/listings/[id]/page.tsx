              ...
              {bookingConfirmed ? (
                ...
                <form onSubmit={handleBookingSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input type="email" required value={userEmail} onChange={(e) => setUserEmail(e.target.value)} className="w-full p-3 rounded-xl border border-gray-200 text-sm bg-gray-50 text-gray-900 focus:outline-none focus:border-[#ae884e]" placeholder="john@example.com" />
                  </div>
                  <div>
